            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus__menu_item">
                        ...
                        <li><a class="{{setActive(['vendor.index'])}}" href="{{route('vendor.index')}}">Ventas</a></li>
                        <li><a class="{{setActive(['flash-sale'])}}" href="{{route('flash-sale')}}">Venta Expres</a></li>
                    ...
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        <li><a href="{{route('product-traking.index')}}">Mi Pedido</a></li>
                        @if (auth()->check())
