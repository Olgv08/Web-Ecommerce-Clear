...
<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      <li><a class="" href="{{url('/')}}"><i class="fas fa-home"></i>Ir a la pagina de inicio</a></li>

      @if (auth()->user()->role === 'vendor')
      <li><a class="{{setActive(['vendor.dashbaord'])}}" href="{{route('vendor.dashbaord')}}"><i class="fas fa-tachometer"></i>Ir al dashboard de proveedor</a></li>
      @endif


      <li><a class="{{setActive(['user.orders.*'])}}" href="{{route('user.orders.index')}}"><i class="fas fa-list-ul"></i> Órdenes</a></li>
