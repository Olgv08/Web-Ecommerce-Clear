                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-7">
                        <div class="wsus__check_form">
                            ...
                            <a href="javascript:;" style="margin-left:auto;" class="common_btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="wsus__order_details" id="sticky_sidebar">
                            <p class="wsus__product">Metodos de envio</p>
                            ...
                            <div class="wsus__order_details_summery">
                                ...
                                <p>Gastos de envio(+): <span id="shipping_fee">{{$settings->currency_icon}}0</span></p>
                            ...
                            <div class="terms_area">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="flexCheckChecked3">
                                        He leido y estoy totalmente deacuerdo <a href="#">Terminos y condiciones *</a>
                                    </label>
                                </div>
                            </div>
