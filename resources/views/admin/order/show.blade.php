              ...
              <div class="invoice-print">
                      ...
                      <div class="col-md-6">
                        <address>
                          <strong>Facturado a:</strong><br>
                            ...
                            <b>Numero de telefono:</b> {{$address->phone}}<br>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <address>
                          ...
                          <b>Metodo:</b> {{$order->payment_method}}<br>
                          <b>Id. de Transacción: </b>{{@$order->transaction->transaction_id}} <br>
                ...
                <div class="row mt-4">
                  <div class="col-md-12">
                    ...
                    <p class="section-lead">No se pueden eliminar todos los elementos aquí contenidos.</p>
                    ...
                    <div class="row mt-4">
                      ...
                      <div class="col-lg-4 text-right">
                        ...
                        <div class="invoice-detail-item">
                            <div class="invoice-detail-name">Cupón (-)</div>
